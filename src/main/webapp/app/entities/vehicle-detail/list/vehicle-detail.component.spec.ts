...
import { sampleWithRequiredData } from '../vehicle-detail.test-samples';
import { VehicleDetailService } from '../service/vehicle-detail.service';

import { VehicleDetailComponent } from './vehicle-detail.component';
import SpyInstance = jest.SpyInstance;

describe('VehicleDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicleDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to vehicleDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVehicleDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVehicleDetailIdentifier).toHaveBeenCalledWith(entity);
