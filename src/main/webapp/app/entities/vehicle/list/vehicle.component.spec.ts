...
describe('Vehicle Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicles?.[0]).toEqual(expect.objectContaining({ vin: 'ABC' }));
  });
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.query).toHaveBeenLastCalledWith(expect.objectContaining({ sort: ['vin,desc'] }));
  });
